...
public class SixBallMode extends SequentialCommandGroup {
  ...
  public SixBallMode(SwerveDriveTrain sSwerve) {
    ...
    addCommands(
      ...
      new SwervePathAction(mSixBallTrajectoryOne).deadlineWith(new IntakeAction(),new TurretAndShooterAction()),
      new WaitCommand(0.5),

      new SwervePathAction(mSixBallTrajectoryTwo).deadlineWith(new IntakeAction(),new TurretAndShooterAction()),
      new ShootAction().withTimeout(1),
      new WaitCommand(0.5),

      new SwervePathAction(mSixBallTrajectoryThree).deadlineWith(new IntakeAction(),new TurretAndShooterAction()),
      new WaitCommand(0.5),

      new SwervePathAction(mSixBallTrajectoryFour).deadlineWith(new IntakeAction(),new TurretAndShooterAction()),
      new ShootAction().withTimeout(1),
      new WaitCommand(0.5),

      new SwervePathAction(mSixBallTrajectoryFive).deadlineWith(new IntakeAction(),new TurretAndShooterAction()),
      new WaitCommand(2),

      new SwervePathAction(mSixBallTrajectorySix).deadlineWith(new IntakeAction(),new TurretAndShooterAction()),
      new ShootAction().withTimeout(1),
      new WaitCommand(0.5),

      new SwervePathAction(mSixBallTrajectorySeven).deadlineWith(new IntakeAction(),new TurretAndShooterAction()),
      new WaitCommand(0.5),

      new SwervePathAction(mSixBallTrajectoryEight).deadlineWith(new IntakeAction(),new TurretAndShooterAction()),
      new ShootAction().withTimeout(1)
    );
  }
}
