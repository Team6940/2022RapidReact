...
public class PPSwerveControllerCommand extends CommandBase {
    ...
    public void execute() {
        ...
        //SmartDashboard.putNumber("Statespeed", targetModuleStates[1].speedMetersPerSecond);
        //SmartDashboard.putNumber("Stateangle", targetModuleStates[1].angle.getDegrees());
