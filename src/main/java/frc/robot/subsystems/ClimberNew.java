...
class ClimbStep {
     ...
     */
    final Consumer<ClimberNew> startAction;
     ...
     */
    final Function<ClimberNew, Boolean> waitCondition;

    /**
     * The action to perform when the state is exited.
     */
    final Consumer<ClimberNew> endAction;
     ...
     */
    ClimbStep(Consumer<ClimberNew> startAction, Function<ClimberNew, Boolean> waitCondition, Consumer<ClimberNew> endAction,
...
public final class ClimberNew extends SubsystemBase {

    private static ClimberNew instance = null;
    ...
    private final  Solenoid latchSolenoid; /* 控制抓手 */
    private final  Solenoid pivotSolenoid; /* 两侧控制机器人倾斜 */
    private final  Solenoid brakeSolenoid; /* 控制elevator刹住不动 */

    private double data;

    private ClimberNew.ClimbState climbState = ClimbState.IDLE;
    ...
    public enum ClimbState {
        ...
        LATCH_PIVOT_ARM(
                new ClimbStep(
                        ...
                        ClimberNew::isPivotingArmLatched,
                        (cl) -> {},
                        true
                )
        ),
    ...
    private ClimberNew() {
        ...
        latchSolenoid = new Solenoid(PneumaticsModuleType.CTREPCM, Constants.LATCH_SOLENOID_ID);
        pivotSolenoid = new Solenoid(PneumaticsModuleType.CTREPCM, Constants.PIVOT_SOLENOID_ID);
        brakeSolenoid = new Solenoid(PneumaticsModuleType.CTREPCM, Constants.BRAKE_SOLENOID_ID);
...
//            }
    ...
    public ClimberNew.ClimbState getClimbState() {
        return climbState;
    }
