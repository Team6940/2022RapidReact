...
public class Turret2 extends SubsystemBase {
    ...
    private static Turret2 instance = null;
    ...
    public void outputTelemetry() {
        SmartDashboard.putString("Debug/Turret2/State", getTurretState().name());
        SmartDashboard.putNumber("Debug/Turret2/Angle", getAngleDeg());

        if (Constants.kOutputTelemetry) {
            SmartDashboard.putNumber("Debug/Turret2/Encoder", periodicIO.position);
            SmartDashboard.putNumber("Debug/Turret2/Demand", periodicIO.demand);
            SmartDashboard.putNumber("Debug/Turret2/Error",
            ...
            if (mTurretMotor.getControlMode() == ControlMode.MotionMagic)
                SmartDashboard.putNumber("Debug/Turret2/Setpoint", mTurretMotor.getClosedLoopTarget(0));
        }
    }
    ...
    public void periodic() {
        ...
        if(LimelightSubsystem.getInstance().getLightMode() == 3){
            Turret2.getInstance().writePeriodicOutputs();
        }
        Turret2.getInstance().outputTelemetry();       
